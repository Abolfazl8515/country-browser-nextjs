  ...
  return (
    <Card className="w-[280px] rounded-xl border border-secondary-400 bg-card text-card-foreground shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
      ...
      <CardContent className="space-y-3">
        <p className="text-secondary-50 bg-primary-600 p-3 rounded-4xl">capital: {capital}</p>
        <p className="text-secondary-50 bg-primary-600 p-3 rounded-4xl">region: {region}</p>
      </CardContent>
    </Card>
  );
}
